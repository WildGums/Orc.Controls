...
namespace Orc.Controls
{
    ...
    public class StaggeredPanel : Panel
    {
        ...
        public static readonly DependencyProperty DesiredColumnWidthProperty = DependencyProperty.Register(
            ...
            new PropertyMetadata(250d, (sender, e) => ((StaggeredPanel)sender).InvalidateMeasure()));
        ...
        public static readonly DependencyProperty PaddingProperty = DependencyProperty.Register(
            ...
            typeof(Thickness),
            typeof(StaggeredPanel),
            new PropertyMetadata(default(Thickness), (sender, e) => ((StaggeredPanel)sender).InvalidateMeasure()));
        ...
        public static readonly DependencyProperty ColumnSpacingProperty = DependencyProperty.Register(
            ...
            typeof(double),
            typeof(StaggeredPanel),
            new PropertyMetadata(0d, (sender, e) => ((StaggeredPanel)sender).InvalidateMeasure()));
