    ...
    public class PredefinedColor : IEquatable<PredefinedColor>
    {
        ...
        private static void Initialize()
        {
            lock (LockSingleton)
            {
                ...
                listColors.AddRange(Initialize_Alphabet());
                listColors.AddRange(Initialize_Windows());
        ...
        /// </summary>
        private static List<PredefinedColor> Initialize_Alphabet()
        {
            var listColors = new List<PredefinedColor>();
        ...
        /// </summary>
        private static List<PredefinedColor> Initialize_Windows()
        {
            var listColors = new List<PredefinedColor>();
