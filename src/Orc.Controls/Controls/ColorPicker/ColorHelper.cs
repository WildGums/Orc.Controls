...
public static class ColorHelper
{
    ...
    public static Color HSB2RGB(double h, double s, double l)
    {
        ...
        var r = GetColorItem(q, p, tr);
        var g = GetColorItem(q, p, tg);
        var b = GetColorItem(q, p, tb);
    ...
    private static byte GetColorItem(double q, double p, double t)
    {
        ...
        const double f16 = 1f / 6f;
        const double f12 = 1f / 2f;
        const double f23 = 2f / 3f;
