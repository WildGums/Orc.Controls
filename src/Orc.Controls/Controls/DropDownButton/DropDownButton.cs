...
#pragma warning restore IDISP004 // Don't ignore created IDisposable.
    ...
    public static readonly DependencyProperty HeaderProperty = DependencyProperty.Register(
        ...
        new PropertyMetadata(default, (sender, _) => ((DropDownButton)sender).OnHeaderChanged()));
    ...
    public static readonly DependencyProperty DropDownProperty = DependencyProperty.Register(nameof(DropDown), typeof(ContextMenu),
        typeof(DropDownButton), new UIPropertyMetadata(default(ContextMenu), (sender, args) => ((DropDownButton)sender).OnDropDownChanged(args)));
