...
namespace Orc.Controls.Converters
{
    ...
    internal class Hour24ToHour12Converter : ValueConverterBase
    {
        ...
        {
            if (IsEnabled && value != null && (AmPm == "AM" || AmPm == "PM"))
            {
                int hour12 = 0;
                if (int.TryParse(value.ToString(), out hour12))
                {
                    ...
                    if (_prev == 12 && hour12 == 11 && AmPm == "PM") AmPm = "AM";
                    else if (_prev == 12 && hour12 == 11 && AmPm == "AM") AmPm = "PM";
                    else if (_prev == 11 && hour12 == 12 && AmPm == "PM") AmPm = "AM";
                    else if (_prev == 11 && hour12 == 12 && AmPm == "AM") AmPm = "PM";
